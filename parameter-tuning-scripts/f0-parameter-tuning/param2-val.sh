...
f0_config='{"dilation_factors":"1,2,4,8,16,32,1,2,4,8,16","corruption":"0.4"}'
f0_model_dir=model/parameter-tuning/f0-parameter-tuning/param2
output_dir=outputs/parameter-tuning/f0-parameter-tuning/param2
num_folds=5
