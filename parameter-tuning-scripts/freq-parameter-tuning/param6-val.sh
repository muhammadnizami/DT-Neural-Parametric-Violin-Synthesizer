...
freq_config='{"dilation_factors":"1,2,4,8,1,2,4","corruption":"0.01"}'

freq_model_dir=model/parameter-tuning/freq-parameter-tuning/param6
freq_output_dir=outputs/parameter-tuning/freq-parameter-tuning/param6
