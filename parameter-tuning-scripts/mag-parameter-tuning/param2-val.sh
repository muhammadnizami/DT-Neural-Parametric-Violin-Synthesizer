...
mag_config='{"dilation_factors":"1,2,4,8,1,2,4","corruption":"0.4"}'

mag_model_dir=model/parameter-tuning/mag-parameter-tuning/param2
mag_output_dir=outputs/parameter-tuning/mag-parameter-tuning/param2
