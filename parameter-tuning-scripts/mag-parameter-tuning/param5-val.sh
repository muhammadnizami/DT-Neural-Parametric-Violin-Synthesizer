...
mag_config='{"dilation_factors":"1,2,4,8,1,2,4","corruption":"0.01"}'

mag_model_dir=model/parameter-tuning/mag-parameter-tuning/param5
mag_output_dir=outputs/parameter-tuning/mag-parameter-tuning/param5
