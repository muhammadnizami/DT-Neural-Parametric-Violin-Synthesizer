...
stoc_config='{"dilation_factors":"1,2,4,8,1,2,4","corruption":"0.01"}'

stoc_model_dir=model/parameter-tuning/stoc-parameter-tuning/param6
stoc_output_dir=outputs/parameter-tuning/stoc-parameter-tuning/param6
