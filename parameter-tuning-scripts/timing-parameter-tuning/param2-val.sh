...
timing_config='{"num_prev_context":5,"num_next_context":5,"max_depth":300}'

timing_model_dir=model/parameter-tuning/timing-parameter-tuning/param2
output_dir=outputs/parameter-tuning/timing-parameter-tuning/param2/
num_folds=5
