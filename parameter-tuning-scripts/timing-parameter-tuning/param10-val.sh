...
timing_config='{"num_prev_context":3,"num_next_context":3,"max_depth":25}'

timing_model_dir=model/parameter-tuning/timing-parameter-tuning/param10
output_dir=outputs/parameter-tuning/timing-parameter-tuning/param10/
num_folds=5
