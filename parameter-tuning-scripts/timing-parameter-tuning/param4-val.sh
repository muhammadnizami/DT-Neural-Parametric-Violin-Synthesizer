...
timing_config='{"num_prev_context":20,"num_next_context":20,"max_depth":300}'

timing_model_dir=model/parameter-tuning/timing-parameter-tuning/param4
output_dir=outputs/parameter-tuning/timing-parameter-tuning/param4/
num_folds=5
