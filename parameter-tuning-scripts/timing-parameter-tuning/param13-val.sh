...
timing_config='{"num_prev_context":3,"num_next_context":3,"max_depth":50}'

timing_model_dir=model/parameter-tuning/timing-parameter-tuning/param13
output_dir=outputs/parameter-tuning/timing-parameter-tuning/param13/
num_folds=5
