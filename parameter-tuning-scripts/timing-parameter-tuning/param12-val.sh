...
timing_config='{"num_prev_context":3,"num_next_context":3,"max_depth":100}'

timing_model_dir=model/parameter-tuning/timing-parameter-tuning/param12
output_dir=outputs/parameter-tuning/timing-parameter-tuning/param12/
num_folds=5
