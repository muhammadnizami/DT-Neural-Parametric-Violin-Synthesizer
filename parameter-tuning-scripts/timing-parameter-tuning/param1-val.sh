...
timing_config='{"num_prev_context":10,"num_next_context":10,"max_depth":300}'

timing_model_dir=model/parameter-tuning/timing-parameter-tuning/param1
output_dir=outputs/parameter-tuning/timing-parameter-tuning/param1/
num_folds=5
