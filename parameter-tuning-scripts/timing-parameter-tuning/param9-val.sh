...
timing_config='{"num_prev_context":1,"num_next_context":1,"max_depth":1000}'

timing_model_dir=model/parameter-tuning/timing-parameter-tuning/param9
output_dir=outputs/parameter-tuning/timing-parameter-tuning/param9/
num_folds=5
